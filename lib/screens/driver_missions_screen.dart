                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.pushNamed(
                            context,
                            '/driver-task-detail',
                            arguments: {'task': task, 'isReport': false},
                          );
                        },
                        child: Container(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              localizations.driver_no_missions,
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w600,
                color: AppColors.lapisLazuli,
            ...
            SizedBox(height: 8),
            Text(
              localizations.driver_no_missions_description,
              style: TextStyle(
                fontSize: 14,
